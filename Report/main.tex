...
\twocolumn[
  \begin{@twocolumnfalse}
    \maketitle
    \begin{abstract}
The project consist in the creation of portfolios, utilizing FTSE MIB index stocks, the main benchmark index of Italian stock markets, using different criteria in order to select the assets of the portfolios, such as R-Squared, Beta Coefficient, Residual variance, Stock variance and returns.
